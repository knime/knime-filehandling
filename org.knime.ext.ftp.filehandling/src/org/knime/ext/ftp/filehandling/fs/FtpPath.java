...
/**
 * {@link Path} implementation for the {@link FtpFileSystem}.
 *
 * @author Vyacheslav Soldatov <vyacheslav@redfield.se>
 */
public class FtpPath extends UnixStylePath {
     ...
     */
    public FtpPath(final FtpFileSystem fileSystem, final String first, final String[] more) {
     ...
     * @param path path.
     */
    public FtpPath(final FtpFileSystem fileSystem, final String path) {
     ...
     */
    @Override
    public FtpPath resolve(final String other) {
