...
final class BinaryObjectsToFilesNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    BinaryObjectsToFilesNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(BinaryObjectsToFilesNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static BinaryObjectsToFilesNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(BinaryObjectsToFilesNodeParameters.class).getParent().resolve("node_settings")
                .resolve("BinaryObjectsToFilesNodeParameters.xml");
