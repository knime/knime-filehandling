...
final class ExtractURIInfoNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    ExtractURIInfoNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ExtractURIInfoNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static ExtractURIInfoNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(ExtractURIInfoNodeParameters.class).getParent().resolve("node_settings")
                .resolve("ExtractURIInfoNodeParameters.xml");
            try (var fis = new FileInputStream(path.toFile())) {
                var nodeSettings = NodeSettings.loadFromXML(fis);
                return NodeParametersUtil.loadSettings(nodeSettings.getNodeSettings(SettingsType.MODEL.getConfigKey()),
                    ExtractURIInfoNodeParameters.class);
            }
