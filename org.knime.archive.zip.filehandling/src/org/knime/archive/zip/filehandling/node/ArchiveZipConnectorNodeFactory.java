...
public class ArchiveZipConnectorNodeFactory extends ConfigurableNodeFactory<ArchiveZipConnectorNodeModel> implements NodeDialogFactory, KaiNodeInterfaceFactory {
    /**
    ...
    private static final List<PortDescription> OUTPUT_PORTS = List.of(
            fixedPort("ZIP Archive File System Connection", """
