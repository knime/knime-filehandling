...
/**
 * {@link Path} implementation for the {@link ArchiveZipFileSystem}.
 *
 * @author Dragan Keselj, KNIME GmbH
 */
public class ArchiveZipPath extends UnixStylePath {
     ...
     */
    ArchiveZipPath(final FSFileSystem<?> fileSystem, final String first, final String[] more) {
