...
import org.knime.archive.zip.filehandling.testing.ArchiveZipFSTestInitializerProvider;
...
/**
 * {@link FSDescriptorProvider} for the ArchiveZip file system.
 *
 * @author Dragan Keselj, KNIME GmbH
 */
public class ArchiveZipFSDescriptorProvider extends BaseFSDescriptorProvider {

    /**
     * {@link FSType} for the ArchiveZip file system.
     */
    public static final FSType FS_TYPE = FSTypeRegistry.getOrCreateFSType("archive-zip", "ZIP archive");

    /**
     * Constructor.
     */
    public ArchiveZipFSDescriptorProvider() {
        super(FS_TYPE, new BaseFSDescriptor.Builder() //
                .withConnectionFactory(ArchiveZipFSConnection::new) // NOSONAR
