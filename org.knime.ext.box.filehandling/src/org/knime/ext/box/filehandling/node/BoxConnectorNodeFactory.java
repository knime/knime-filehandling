 ...
 */
public class BoxConnectorNodeFactory extends NodeFactory<BoxConnectorNodeModel> {
    ...
    @Override
    public NodeView<BoxConnectorNodeModel> createNodeView(final int viewIndex, final BoxConnectorNodeModel nodeModel) {
        return null;
    }
