...
import org.knime.ext.box.filehandling.testing.BoxFSTestInitializerProvider;
...
/**
 * {@link FSDescriptorProvider} for the Box file system.
 *
 * @author Alexander Bondaletov, Redfield SE
 */
public class BoxFSDescriptorProvider extends BaseFSDescriptorProvider {

    /**
     * {@link FSType} for the Box file system.
     */
    public static final FSType FS_TYPE = FSTypeRegistry.getOrCreateFSType("box", "Box");

    /**
     * Creates new instance
     */
    public BoxFSDescriptorProvider() {
        super(FS_TYPE, new BaseFSDescriptor.Builder() //
                .withConnectionFactory(BoxFSConnection::new) // NOSONAR
                .withSeparator(BoxFileSystem.SEPARATOR) //
                .withURIExporterFactory(URIExporterIDs.DEFAULT, PathURIExporterFactory.getInstance()) //
                .withTestInitializerProvider(new BoxFSTestInitializerProvider()) //
                .build());
    }
