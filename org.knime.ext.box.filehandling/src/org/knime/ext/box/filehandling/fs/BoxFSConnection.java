...
/**
 * {@link FSConnection} for the Box file system.
 *
...
public class BoxFSConnection extends BaseFSConnection {
     ...
     *
     */
    public BoxFSConnection(final BoxFSConnectionConfig config) throws IOException {
        m_filesystem = new BoxFileSystem(CACHE_TTL, config);
    }
