 ...
 */
public class BoxFSTestInitializer extends DefaultFSTestInitializer<BoxPath, BoxFileSystem> {

    /**
     * @param fsConnection
     *            FS connection.
     */
    protected BoxFSTestInitializer(final FSConnection fsConnection) {
        super(fsConnection);
    }
