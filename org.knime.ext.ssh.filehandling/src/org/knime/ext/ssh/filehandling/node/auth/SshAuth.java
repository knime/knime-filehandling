...
/**
 * Defines authentication constants and utility methods for SSH authentication.
 *
...
public final class SshAuth {
     ...
     */
    public static final AuthType KEY_FILE_AUTH_TYPE = new AuthType("key", "Key file",
            "Public/Private key based authentication");

    /**
     * Creates {@link AuthSettings} for the SSH Connector node settings.
     *
     * @param cfg
     * @return a new {@link AuthSettings}.
     */
