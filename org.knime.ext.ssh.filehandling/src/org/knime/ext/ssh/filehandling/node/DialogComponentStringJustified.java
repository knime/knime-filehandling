 ...
 *
 * History
 *   2020-09-05 (Vyacheslav Soldatov): created
 */
...
/**
 * {see DialogComponentString}
 *
 * Component with text field justified to all component width.
 *
 * @author Vyacheslav Soldatov <vyacheslav@redfield.se>
 */
class DialogComponentStringJustified extends DialogComponent {
    ...
    /**
     * Constructor put label and JTextField into panel. It will accept empty strings
     * as legal input.
     *
     * @param stringModel
     *            the model that stores the value for this component.
     * @param label
     *            label for dialog in front of JTextField
     */
    public DialogComponentStringJustified(final SettingsModelString stringModel, final String label) {
     ...
     *            user.
     * @param compWidth
     *            the width of the edit field (in columns/characters)
     */
    public DialogComponentStringJustified(final SettingsModelString stringModel, final String label,
     ...
     */
    public DialogComponentStringJustified(final SettingsModelString stringModel, final String label,
            final boolean disallowEmptyString, final int compWidth, final FlowVariableModel fvm) {
        super(stringModel);
        ...
        getComponentPanel().add(m_label, BorderLayout.WEST);
        ...
        getComponentPanel().add(m_valueField, BorderLayout.CENTER);
    ...
    /**
     * @param defaultValue
     *            the default value in the component
     * @return the width of the spinner, derived from the defaultValue.
     */
    static int calcDefaultWidth(final String defaultValue) {
     ...
     *             if the string was not accepted.
     */
     ...
     */
    public BorderLayout getComponentLayout() {
        return (BorderLayout) getComponentPanel().getLayout();
    }
}
