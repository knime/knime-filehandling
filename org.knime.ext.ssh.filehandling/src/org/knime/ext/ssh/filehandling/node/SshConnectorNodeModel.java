...
public class SshConnectorNodeModel extends WebUINodeModel<SshConnectorNodeParameters> {
    ...
    static SshFSConnectionConfig createConnectionConfig(final SshConnectorNodeParameters settings,
            final Optional<PortObjectSpec> optFsConPort, final CredentialsProvider credentials)
            throws InvalidSettingsException {
        return settings.toFSConnectionConfig(credentials, new DefaultBridge(settings, optFsConPort));
    }
