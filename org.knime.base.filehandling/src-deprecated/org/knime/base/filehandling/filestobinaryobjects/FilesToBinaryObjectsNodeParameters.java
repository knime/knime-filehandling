...
class FilesToBinaryObjectsNodeParameters implements NodeParameters {
     ...
     *
     * Option: Append or replace
     * <b>Append</b> <br /> Does append the new column to the table. <br /> <b>Replace</b> <br /> Does
     * replace the selected column with the new column.
     *
     * Option: New column name
