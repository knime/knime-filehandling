...
public class StringsToBinaryObjectsNodeFactory extends NodeFactory<StringsToBinaryObjectsNodeModel>
    ...
    private static final String SHORT_DESCRIPTION = "Converts the strings of a column to binary objects.";
    private static final String FULL_DESCRIPTION = "This node converts the string cells to binary object cells.";
    private static final List<PortDescription> INPUT_PORTS = List.of(
            fixedPort("Input table", "Table that contains the string that will be converted.")
    );
