...
public final class ModelToBinaryObjectNodeFactory extends NodeFactory<ModelToBinaryObjectNodeModel> {
    ...
    public ModelToBinaryObjectNodeModel createNodeModel() {
        return new ModelToBinaryObjectNodeModel();
    }
    ...
    @Override
    public NodeView<ModelToBinaryObjectNodeModel> createNodeView(final int viewIndex,
        final ModelToBinaryObjectNodeModel nodeModel) {
        return null;
    }
