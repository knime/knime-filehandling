...
final class BinaryObjectsToFilesNodeConfig
    extends AbstractMultiTableWriterNodeConfig<BinaryObjectDataValue, BinaryObjectsToFilesNodeConfig> {

    private static final String WRITER_TYPE_NAME = "binary object";
    ...
    BinaryObjectsToFilesNodeConfig(final PortsConfiguration portsConfiguration,
        ...
        super(portsConfiguration, connectionInputPortGrouptName, BinaryObjectDataValue.class,
            new BinaryObjectsToFilesNodeConfigSerializer(), true);
        getFilenamePattern().setStringValue("File_?.dat");
    }
