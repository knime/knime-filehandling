 ...
 * @since 2.11
 */
public class SSHRemoteFileHandler implements RemoteFileHandler<SSHConnection> {

    /**The {@link Protocol} of this {@link RemoteFileHandler}.*/
    public static final Protocol PROTOCOL = new Protocol("ssh", 22, false, true, true, true, true, true, true, false);
    ...
    public RemoteFile<SSHConnection> createRemoteFile(final URI uri, final ConnectionInformation connectionInformation,
        ...
        final SFTPRemoteFile sftpFile = new SFTPRemoteFile(uri, connectionInformation, connectionMonitor);
        return sftpFile;
    }
}
