...
public class ZipNodeDialog extends NodeDialogPane {
    ...
    private DialogComponentButtonGroup m_format;
    ...
    public ZipNodeDialog() {
        ...
        final SettingsModelString formatsettings = SettingsFactory.createFormatSettings();
        ...
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        m_format = new DialogComponentButtonGroup(formatsettings, false, "Output format", Format.getAllSettings());
        panel.add(m_format.getComponentPanel(), gbc);
        // Target zip file
        gbc.anchor = GridBagConstraints.WEST;
        gbc.gridx = 0;
        gbc.gridy = 1;
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
        ...
        m_format.loadSettingsFrom(settings, specs);
    }
