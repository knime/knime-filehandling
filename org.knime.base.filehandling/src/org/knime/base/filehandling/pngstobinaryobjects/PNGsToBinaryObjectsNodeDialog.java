 ...
 */
public class PNGsToBinaryObjectsNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected PNGsToBinaryObjectsNodeDialog() {
        super();
        ...
        addDialogComponent(new DialogComponentColumnNameSelection(
                m_columnselection, "Column selection", 0, PNGImageValue.class));
