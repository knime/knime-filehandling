...
/**
 * Node parameters for Binary Objects to Strings.
 *
...
final class BinaryObjectsToStringsNodeParameters implements NodeParameters {
    ...
    private static final class DecodingPersistor implements NodeParametersPersistor<Decoding> {

        private static final String CFG_KEY = "decoding";
        ...
        @Override
        public void save(final Decoding obj, final NodeSettingsWO settings) {
    ...
    private enum OutputMode {
            @Label(value = "Replace",
                    description = "Replaces the selected binary object column with the string column.")
            REPLACE, //
            @Label(value = "Append", description = "Appends a new string column to the table.")
            APPEND;
    }
