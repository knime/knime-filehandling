...
final class SettingsFactory {
    ...
    /**
     * Factory method for the decoding setting.
     * 
     * 
     * @return Decoding <code>SettingsModel</code>
     */
    static SettingsModelString createDecodingSettings() {
        return new SettingsModelString("decoding", Decodings.UTF_8);
    }
    ...
    static SettingsModelString createColumnNameSettings(final SettingsModelString replacePolicy) {
        SettingsModelString columnName = new SettingsModelString("columnname", "String");
