...
/**
 * Data sink for URIs that have no specific data sink defined.
 * 
 * 
...
public class DefaultDataSink implements DataSink {
    ...
    /**
     * Creates a data sink that uses the stream from <code>java.net.URL</code>.
     * 
     * 
     * @param uri URI that determines the resource used
     * @throws Exception If the resource is not reachable
     */
    public DefaultDataSink(final URI uri) throws Exception {
        URLConnection con = uri.toURL().openConnection();
        con.setDoOutput(true);
        m_stream = con.getOutputStream();
    }
