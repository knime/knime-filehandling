...
/**
 * Node parameters for Find MIME-Type.
 *
...
final class FindMIMETypeNodeParameters implements NodeParameters {

    @Widget(title = "Column selection", description = "Column that contains the URIs.")
    @ChoicesProvider(URIColumnProvider.class)
    ...
    private interface ColumnSelectionRef extends ParameterReference<String> {
    }

    private static final class URIColumnProvider extends CompatibleColumnsProvider {

        protected URIColumnProvider() {
            super(URIDataValue.class);
        }
    }

    private static final class ColumnSelectionProvider extends ColumnNameAutoGuessValueProvider {
        ...
        protected Optional<DataColumnSpec> autoGuessColumn(final NodeParametersInput parametersInput) {
            final var compatibleColumns = ColumnSelectionUtil.getCompatibleColumnsOfFirstPort(
                parametersInput, URIDataValue.class);
