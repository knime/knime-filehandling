...
public class BoxAuthenticatorNodeFactory extends WebUINodeFactory<BoxAuthenticatorNodeModel> {
    private static final String FULL_DESCRIPTION = """
                    <p>This node authenticates against <a href="https://box.com/">Box</a>. The resulting
                    credential can then be used with the Box Connector node. The following authentication
                    methods are supported:
                    <ul>
                    <li><a href="https://developer.box.com/guides/authentication/oauth2/">User
                    Authentication (OAuth 2.0)</a></li>
                    ...
                    as follows:
                    <ul>
                    <li>Create a <a href="https://developer.box.com/guides/applications/custom-apps/">
                    Custom App</a> in Box. While creating the app choose the authentication method you want to use in
                    KNIME (OAuth 2.0 or Client Credentials Grant).</li>

                    <li>For Client Credentials Grant, configure the app as follows: Set <b>Access Level = App +
                    Enterprise Access</b> (to be able to access files/folders of your Box enterprise), and
                    <b>Application Scopes = Write all files and folders stored in Box.</b>
                    </li>

                    <li>For OAuth 2.0, configure the app as follows: Set <b>OAuth 2.0 Redirect
                    URI = http://localhost</b>, and <b>Application Scopes = Write all files and folders stored in
                    Box.</b>
                    </li>
    ...
    private static final WebUINodeConfiguration CONFIGURATION = WebUINodeConfiguration.builder()//
            .name("Box Authenticator (deprecated)")//
            .icon("./oauth.png")//
