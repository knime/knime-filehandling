...
public class BoxAuthenticatorNodeFactory extends WebUINodeFactory<BoxAuthenticatorNodeModel> {
    private static final String FULL_DESCRIPTION = """
                    ...
                    (e.g. scheduled or Data App). For further details on which authentication method to select see the
                    <a href="https://developer.box.com/guides/authentication/select/">Box documentation.</a>
                    </p>

                    <p>
                    To use <b>User authentication</b>, you can either use the Default App or create and use
                    ...
                    To use a Custom App it has to be created and approved in Box first. The steps are as follows:
                    <ul>
                    ...
                    <p>
                    To use <b>Server authentication</b>, a Custom App has to be created and approved in Box first.
                    ...
                    KNIME Analytics Platform, i.e. execution on KNIME (Business) Hub, KNIME Server, or via Remote
