 ...
 *
 * History
 *   2021-05-13 (Alexander Bondaletov): created
 */
...
class SmbConnectorSettings {
    ...
    public SmbConnectorSettings() {
        ...
        m_authSettings = new AuthSettings.Builder() //
                ...
                .add(new EmptyAuthProviderSettings(SmbFSConnectionConfig.KERBEROS_AUTH_TYPE)) //
                .add(new EmptyAuthProviderSettings(SmbFSConnectionConfig.GUEST_AUTH_TYPE)) //
