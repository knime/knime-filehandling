 ...
 */
public class EmbeddedFtpTestInitializerProvider extends DefaultFSTestInitializerProvider {

    @Override
    public DefaultFSTestInitializer<FtpPath, FtpFileSystem> setup(final Map<String, String> cfg) throws IOException {
        try {
            return new EmbeddedFtpTestInitializer(toFSConnectionConfig(cfg));
    ...
    public FSType getFSType() {
        return EmbeddedFtpFSDescriptorProvider.FS_TYPE;
    }
